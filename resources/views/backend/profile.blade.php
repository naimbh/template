            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8 col-md-10">
                    <div class="card card-widget widget-user">
                        ...
                        <div class="widget-user-header bg-info text-capitalize">
                            <h2 class="widget-user-username">{{env('APP_NAME')}}</h2>
                        ...
                        <div class="card-body pad">
                            <form method="get" action="{{route('user.edit', auth()->user()->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Input a new password.." name="password"
                                           class="form-control" required>
                                </div>
